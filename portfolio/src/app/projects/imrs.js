...
const Imrs = () => {
    ...
    const info = {
        summary: <p className="pb-4">Developed a critical safety mobile app in collaboration with A-Shield LLC and
            a University of North Texas IT group. The app enhances law enforcement response during active
